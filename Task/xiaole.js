...
第一步 微信扫码 https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.png  获取授权
...
############## 圈x
#小乐获取ck
https:\/\/minapp\.xqrobot\.net\/* url script-request-header https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.js

############## loon

#小乐获取ck
http-request https:\/\/minapp\.xqrobot\.net\/* script-path=https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.js, requires-header=true, tag=小乐获取ck

############## surge

#小乐获取ck
小乐获取ck = type=http-request,pattern=https:\/\/minapp\.xqrobot\.net\/*,script-path=https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.js, 
...
async function all() {
    if (!Length) {
        $.msg(
            $.name,
            '提示：⚠️请点击前往获取cookie\n',
            'https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.png', {
                "open-url": "https://raw.githubusercontent.com/jackpater/App_auto/main/Task/xiaole.png"
            }
        );
        return;
    }
